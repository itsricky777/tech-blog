              ...
              <form method="post" action="<?php echo base_url('admin/articlelist/edit') . '/' . $post->article_id;?>" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter ..." name="title" required value="<?php echo $post->title ?>">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-lg">
                      <!-- textarea -->
                      <div class="form-group">
                        <textarea class="form-control"  placeholder="Enter ..." name="opening-txt" required><?php echo $post->opening_txt; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-lg">
                      <!-- textarea -->
                      <div class="form-group">
                        <textarea class="form-control"  placeholder="Enter ..." name="content" required><?php echo $post->opening_txt; ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
