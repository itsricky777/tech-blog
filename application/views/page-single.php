        ...
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="tech-index.html"><img src="<?php echo base_url();?>public/images/version/tech-logo.png" alt=""></a>
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mr-auto">
                            <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo base_url()?>nav/show">Home</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper d-flex justify-content-center">
                            ...
                            <div class="single-post-media">
                                <img src="<?php echo base_url();?>public/upload/tech_menu_08.jpg" alt="" class="img-fluid">
                            </div><!-- end media -->
